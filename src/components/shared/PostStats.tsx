...
const PostStats = ({ post, userId }: PostStatsProps) => {
  ...
  // İlk olarak tüm hook'ları koşulsuz olarak tanımlayalım
  ...
  // savedPostRecord'u useEffect içinde hesaplayalım
  useEffect(() => {
    if (currentUser && post) {
  ...
  // Post veya kullanıcı yoksa veya veri yükleniyorsa erken return
  if (!post || !userId || isLoading || !currentUser) {
    return null;
  }
