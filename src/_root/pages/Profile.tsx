...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    } else if (id !== user.id && isError) {
      navigate(`/profile/${user.id}`);
    }
  }, [user, id, isError, navigate]);
          ...
          {user.id === currentUser.$id && (
            <div className="flex justify-center gap-4">
              <Link
                ...
                className="h-12 bg-primary-700 px-5 text-light-1 flex-center gap-2 rounded-lg"
              >
                <img
        ...
        <div className="flex max-w-5xl w-full">
          ...
          <Link
            ...
            className={`profile-tab rounded-r-lg ${
              pathname === `/profile/${id}/liked-posts` && "!bg-vg-2"
            }`}
          >
